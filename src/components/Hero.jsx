export default function Hero() {
  return (
    <>
        <h5>Complete this traing program if you want to</h5>   
        ...
        <ul className="rules-list">
          ...
          <div className="rule-item">
            <p><b>Reps</b></p>
            <p>Every rep is a pause rep following a <abbr title="2 seconds down - 2 seconds pause - 2 seconds up">2 - 2 - 2</abbr></p>
          </div>
          <div className="rule-item">
            <p><b>Weight*</b></p>
            <p>Select the maximum weight that allows you to complete the set with a good form</p>
          </div>
        </ul>
